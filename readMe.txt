ValleyBikeSim: Smith College / CSC223 / A4
...
2. Install Eclipse, (using the following link): [https://www.eclipse.org/downloads/packages/release/2019-06/r/eclipse-ide-java-developers](https://www.eclipse.org/downloads/packages/release/2019-06/r/eclipse-ide-java-developers)
...
3. Click "Next"
4. Choose "Clone URI"
5. Copy and paste ([https://github.com/hnc13/a4.git]) into the URI field.
6. Click "Next"
...
We don't have any dependencies or coding references.
